	...
	return (
		<Fragment>
				...
				<div className="opry-block-sidebar">
							...
							{(!bgMediaURL) ? (
								...
								<Fragment>
									<div className="image-preview">
										<img src={bgMediaURL} alt={__('bg preview', 'opry-plugin')} />
									</div>
									<MediaUploadCheck>
										<MediaUpload
											onSelect={item => {
					...
					{boxList.map((box, index) => {
						...
						return (
							<Fragment key={index}>
								{isCardOpen &&
									<PanelBody title={__(`Box ${index + 1} Settings`, 'opry-plugin')} initialOpen={true}>
										<TextControl
											type="url"
											label={__('box URL', 'opry-plugin')}
			...
			<div className={classes} id={blockID} style={blockStyle}>
							...
							<a key={index} className={boxDetailClass} style={boxStyle}>
								...
								<div className="item-action-wrap small-icons">
									<div className="move-item">
										{0 < index && (
											<Tooltip text={__('Move Left', 'opry-plugin')}>
												<span
										...
										{index + 1 < boxList.length && (
											<Tooltip text={__('Move Right', 'opry-plugin')}>
												<span
									...
									<div className="show-program-card__cnt">
										...
										<div className="btn-main-border btn-secondary-gradient-blue-1 btn-has-right-arrow">
											<RichText
												...
												placeholder={__('Enter Button Text', 'opry-plugin')}
											/>
										</div>
									</div>
								</div>
				...
				>
					<Tooltip text={__('Add New Contact', 'opry-plugin')}>
						<i
