				...
				{repeatItems.length > 0 && (
					<div className="image-preview">
						<div className="image-controls small-icons image-action-wrap">
							<Tooltip text={__("Remove Slide", 'opry-plugin')}>
								<i
									className="remove-image dashicons dashicons-no-alt"
									onClick={() => {
										let toDelete = confirm(__('Are you sure you want to delete this item?', 'opry-plugin'));
										if (true === toDelete) {
		...
		<Fragment>
			<InspectorControls>
				<div className="opry-block-sidebar">
					...
					<PanelBody
						title={__('Slider Settings', 'opry-plugin')}
						initialOpen={false}
					>
						<PanelRow>
							<label htmlFor="Display Mode">
								{__('Autoslide', 'opry-plugin')}
							</label>
							<FormToggle
								label="auto"
								checked={autoplay}
						...
						<PanelRow>
							<label htmlFor="Display Mode">
								{__('Dots Visibility', 'opry-plugin')}
							</label>
							<FormToggle
								checked={dots}
								onChange={() =>
						...
						<PanelRow>
							<label htmlFor="Display Mode">
								{__('Arrows Visibility', 'opry-plugin')}
							</label>
							<FormToggle
								checked={arrows}
								onChange={() =>
