		...
		<Fragment>
			<InspectorControls>
				<div className="opry-block-sidebar">
					<PanelBody
						title={__('Settings', 'opry-plugin')}
						initialOpen={true}
					>
						<ToggleControl
							label={__('Show Media Caption', 'opry-plugin')}
						...
						<div className="inspector-field inspector-field-alignment">
							<label className="inspector-mb-0">
								{__('Media Alignment', 'opry-plugin')}
							</label>
					...
					{'video' === mediaType && (
						<PanelBody
							title={__('Column Video Settings', 'opry-plugin')}
							initialOpen={false}
						>
							<div className="setting-row">
								<label>
									{__('Poster Image', 'opry-plugin')}
								</label>
								<div>
									{!videoPoster ? (
										<MediaUpload
										...
										<div className='panel_text'>
											...
											<div className='btn-group'>
												<RichText
													value={btnOneText}
													tagName="p"
													placeholder={__('Button One Text', 'opry-plugin')}
												...
												<RichText
													value={btnTwoText}
													tagName="p"
													placeholder={__('Button Two Text', 'opry-plugin')}
