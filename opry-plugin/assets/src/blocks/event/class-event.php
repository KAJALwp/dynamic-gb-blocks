<?php
/**
 * Registers the opry-plugin/event block.
 *
...
/**
 *  Class for the opry-plugin/event block.
 */
		...
		<div <?php echo wp_kses_post( $wrapper_attributes ); ?>>
			<div class="opry-event__row">
				...
				if ( $query->have_posts() ) {
								...
								<div class="event-cards">
									<div class="info">
										<div class="info-inner">
											...
											<a class="opry-get-ticket-anchor" href="<?php the_permalink(); ?>"><?php echo esc_html__( 'Get Tickets', 'opry-plugin' ); ?></a>
										</div>
									</div>
									</div>
					...
					?>
					<div class="opry-event__item">
						<p><?php echo __( 'No Event Found', 'opry-plugin' ); ?></p>
					</div>
					<?php
				}
				?>
